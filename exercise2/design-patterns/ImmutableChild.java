...
*/
public final class ImmutableChild { // or not?
    ...
    public ImmutableChild(final int age, final String name, final List<String> favouriteBooks) {
        this.age = age;
        this.name = name;
        if (favouriteBooks == null) {
            throw new RuntimeException("Not a single favourite book?!");
        }
        this.favouriteBooks = favouriteBooks.subList(0, 1);
    }
